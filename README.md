...
│   ├── 🌐 Domain: guestbook-moumen.duckdns.org
│   ├── 🔄 Auto-renewal: Yes
...
```
1. 🌐 User visits https://guestbook-moumen.duckdns.org/
...
- DNS record pointing `guestbook-moumen.duckdns.org` to your cluster
...
2. **Update Repository Name in kustomization.yaml**:
   ...
   # Change: ghcr.io/TheM2121/guestbook-gitops
   ```
